...
function createFixtures() {
  ...
  try {
    ...
    console.error('Could not compile Java file. You may need to install JDK or compile it manually.');
    ...
    if (!fs.existsSync(TEST_CLASS_PATH)) {
      ...
      console.log('NOTE: This is not a valid Java class file. Tests will run but will likely fail.');
    }
  }
